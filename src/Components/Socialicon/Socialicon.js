...
export default function Socialicon() {
  return (
   ...
   {/* linkedin */}
     <a href="https://www.linkedin.com/in/aadit-yadav-b17636258/" target='_'>
  ...
  <div className="child child-4">
    ...
    {/* GMAIL */}
  <a class="socialContainer containerFour" href="mailto:yaaditya191@gmail.com" target='_'>
  <div className="child child-5">
  <button className="button btn-5">
    <svg
      viewBox="0 0 16 16"
      fill="currentColor"
      height="16"
